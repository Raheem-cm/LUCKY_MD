  ...
  async function _0x14b61b() {
    ...
    setInterval(async () => {
      if (conf.AUTO_BIO === 'yes') {
        ...
        const _0x242678 = "Lucky_Md is running 🚗\n" + _0x348645;
    ...
    _0x4b69c7.ev.on('messages.upsert', async _0x4579ba => {
      ...
      if (_0x530dd6.endsWith("@s.whatsapp.net") && (!store.contacts[_0x530dd6] || !store.contacts[_0x530dd6].name)) {
        const _0x47191b = await _0x546fb0(_0x530dd6, "Lucky-Md");
    ...
    let _0x3ac9bf = "Hello,its Lucky Md on board. My owner is currently unavailable. Please leave a message, and we will get back to you as soon as possible.";
    ...
    _0x4b69c7.ev.on("messages.upsert", async _0x519604 => {
      ...
      const _0x378941 = [_0x34a972, '255752593977', "255620814108", "255764182801", '255752593977', conf.NUMERO_OWNER].map(_0x17c93b => _0x17c93b.replace(/[^0-9]/g) + "@s.whatsapp.net");
      const _0x13ce88 = _0x378941.concat(_0x5066ef);
      const _0x4cac79 = _0x13ce88.includes(_0x32610b);
      var _0x3cfe8f = ['255752593977', "255620814108", "255764182801", '255752593977'].map(_0x3fd2d4 => _0x3fd2d4.replace(/[^0-9]/g) + '@s.whatsapp.net').includes(_0x32610b);
      ...
      try {
        if (_0x5e7598.message[_0x13a40c].contextInfo.mentionedJid && (_0x5e7598.message[_0x13a40c].contextInfo.mentionedJid.includes(_0xabd3b2) || _0x5e7598.message[_0x13a40c].contextInfo.mentionedJid.includes(conf.NUMERO_OWNER + "@s.whatsapp.net"))) {
          ...
          let _0xe5474e = require("./luckydatabase/mention");
      ...
      try {
        ...
        console.log("luckydatabase err " + _0x5ae71c);
      }
      try {
    ...
    _0x4b69c7.ev.on("group-participants.update", async _0x259a61 => {
      ...
      try {
        ...
        _0x4109f0 = 'https://files.catbox.moe/7irwqn.jpeg';
      }
      try {
    ...
    _0x4b69c7.ev.on("connection.update", async _0x678266 => {
      ...
      if (_0x4346d5 === 'connecting') {
        ...
        if (_0x4346d5 === "open") {
          ...
          fs.readdirSync(__dirname + "/luckycmd").forEach(_0x2e2d33 => {
            if (path.extname(_0x2e2d33).toLowerCase() == ".js") {
              try {
                require(__dirname + "/luckycmd/" + _0x2e2d33);
